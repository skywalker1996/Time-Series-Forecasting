...
class TestNet(BasicModule):
    def __init__(self, name, seq_len=10):
        ...
        self.linear_reg_2 = nn.Linear(10,1)
...
class FCNet(BasicModule):
    ...
    def __init__(self, name, history_len=10, forecast_len=1):
        ...
        self.linear_reg_1 = nn.Linear(self.seq_len,10)
        self.linear_reg_2 = nn.Linear(10,self.forecast_len)
        self.linear_cla_1 = nn.Linear(self.seq_len,10)
        self.linear_cla_2 = nn.Linear(10,2)
    def forward(self, x):
        # out = (batch, seq_len, num_directions * hidden_size)
        # hidden = (hn, cn)，维度同上
